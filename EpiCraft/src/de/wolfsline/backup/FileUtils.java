...
public class FileUtils {
     ...
     */
    public static void copyFiles(File src, File dest, Epicraft plugin) throws IOException {
        ...
        if (src.isDirectory()) 	{
            ...
            try {
                ...
                if (plugin != null) {
                	plugin.api.sendLog("[Epicraft - Backup] Fehler beim Kopieren -> " + src.getAbsolutePath() + " nach " + dest.getAbsolutePath());
                } else {
